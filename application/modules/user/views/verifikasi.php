                ...
                <section class="section">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>Tabel Data Role Verification User</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <?php $i =1;?>
                                        <?php foreach ($role as $r) :?>
                                            <tr>
                                                ...
                                                <a class="btn waves-effect waves-light btn-warning text-white" href="<?= base_url('user/change_verifikasi_user/' .$r['id']) ?>"> <i class="fa fa-pencil-alt"></i> Verification User</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                </tbody>
